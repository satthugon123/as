...
<html>
    ...
    <body>
        ...
        <form action="MainController" method="post">
            <input type="hidden" name="action" value="doAddProduct">
            <table>
                <tr>
                    <td>Product Name:</td>
                ...
                <tr>
                    ...
                    <td><input type="number" name="quantityPerUnit" required></td>
                </tr>
                <tr>
                    <td>Unit Price:</td>
                    <td><input type="number" step="0.01" name="unitPrice" required></td>
                </tr>
                <tr>
